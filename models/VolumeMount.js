...
class VolumeMount extends BaseModel {
    ...
    constructor({ host_path, container_path }) {
        super();
        if (typeof host_path !== 'string') throw new TypeError('host_path must be string');
        if (typeof container_path !== 'string') throw new TypeError('container_path must be string');
